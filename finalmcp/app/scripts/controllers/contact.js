...
*/
              ...
              //  'Fluctuation / Index Ratio: ' + numberFormat(p.value.fluctuationPercentage) + '%'
									      ...
									      .compose([
									      	dc.lineChart(compositeChart).group(budgeted, 'Budget').colors(['#bb00cf']).ordinalColors(["red"]).renderDataPoints({radius: 0.1, fillOpacity: 0.1, strokeOpacity: 0.1}).dashStyle([5,5]),
    ...
    .attr("text", function(d) { return d.value ;}) })*/
										...
										categoryRingChart
										    ...
										    .brushOn(false)
										    .yAxisLabel("Savings")
											.ordinalColors(['#4682b4','#FF2000','#FF3800','#FF4F00','#FF6A00','#FF8800','#682049'])
										    //.x(d3.time.scale().domain([minDate, maxDate]))
										    .xAxis();
